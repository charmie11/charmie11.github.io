...
settings = {
    ...
    'voltage_noise': {'min': 0.0, 'max': 2.0, 'step': 0.01, 'default': 0.0, 'text': r"\[\sigma_v \] (電圧計測ノイズ強度)"},
    'current_noise': {'min': 0.0, 'max': 0.5, 'step': 0.01, 'default': 0.0, 'text': r"\[\sigma_i \] (電流計測ノイズ強度)"},
}
